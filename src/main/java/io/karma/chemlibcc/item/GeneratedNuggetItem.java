 ...
 * @since 12/10/2024
 */
public final class GeneratedNuggetItem extends GeneratedChemicalItem implements BuiltinRendererItem {
    public GeneratedNuggetItem(final ResourceLocation name,
