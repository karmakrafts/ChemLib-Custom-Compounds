 ...
 * @since 12/10/2024
 */
public final class GeneratedIngotItem extends GeneratedChemicalItem implements BuiltinRendererItem {
    public GeneratedIngotItem(final ResourceLocation name,
